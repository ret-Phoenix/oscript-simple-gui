...
- Элементы/Items 
  - Возвращаемое значение
    - Коллекция с [ПолеФормы](#ПолеФормыformfield), [ГруппаФормы](#ГруппаФормыformgroup), [КнопкаФормы](#КнопкаФормыformbutton)
...
### Свойства
  ...
  - Родитель/Parent - [ГруппаФормы](#ГруппаФормыformgroup), [УправляемаяФорма](#Формаform) - Только чтение - Содержит ссылку на родительский элемент.
...
### Свойства
 ...
 - [Вид/Type](#ВидПоляФормыformfieldtype) - ВидПоляФормы
 - Имя/Name - Строка
 - Видимость/Visible - Булево 
 - Доступность/Enabled - Булево
 - Заголовок/Title - Строка
 - [ПоложениеЗаголовка/TitleLocation](#ПоложениеЗаголовка) - ПоложениеЗаголовка
 - СписокВыбора/ChoiceList - Соответствие
 - Родитель/Parent - [ГруппаФормы](#ГруппаФормыformgroup), [УправляемаяФорма](#Формаform) - Только чтение
