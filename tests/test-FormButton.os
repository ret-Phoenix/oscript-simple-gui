...
Процедура Тест_Должен_ВернутьРодителя() Экспорт
	...
	Поле = Форма.Элементы.Добавить("Поле1", "ПолеФормы", Группа);
	юТест.ПроверитьРавенство(Строка(Поле.Родитель), "ГруппаФормы");
...
Процедура Тест_Должен_ПолучитьДействие() Экспорт
	...
	// Сообщить("ЭО: " + ЭтотОбъект.Источник);
	Сообщить("Действие: " + Кнопка2.ПолучитьДействие("Нажатие"));
