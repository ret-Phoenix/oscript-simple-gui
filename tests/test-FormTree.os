...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	СписокТестов.Добавить("Тест_Должен_ВернутьУровень");
...
Процедура Тест_Должен_ОбработатьТекущиеДанные() Экспорт
	...
	// юТест.ПроверитьРавенство(ТекЗначение, "2017");
...
Процедура Тест_Должен_ВернутьУровень() Экспорт
